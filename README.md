...
both their daily meal consumption and physical activities. Poor dietary habits and sedentary lifestyles remain among the leading contributors 
...
## Proposed Features
- Meal and Activity Log
- Nutritional and Physical Activity Statistics
- Goal Setting
- Progress Reports
...
- OOP: Planned use of classes such as User, MealLog, ActivityLog, NutritionalDetails, etc.
